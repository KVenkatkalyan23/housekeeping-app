  ...
  return (
    <header className="flex items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#202b3d] text-sm font-semibold text-white shadow-[0_12px_24px_rgba(15,23,42,0.18)]">
          {(username ?? 'S').slice(0, 1).toUpperCase()}
        </div>
        <div>
          <h1 className="text-[1.35rem] font-semibold tracking-[-0.04em] text-[#23324d]">
            Attendance
          </h1>
